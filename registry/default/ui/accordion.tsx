...
>(({ className, children, hideBackground, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    ...
    >
      {!hideBackground && (
        <div className="absolute inset-0 -mx-2 my-1 rounded-lg bg-gray-150 transition-colors group-hover/accordion:bg-gray-200 md:-mx-3 dark:bg-gray-750 dark:group-hover/accordion:bg-gray-700" />
      )}
      <div
