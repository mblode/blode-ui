  ...
  (
    ...
    <BottomSheetPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed bottom-0 left-1/2 z-100 w-full -translate-x-1/2 translate-y-0 duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:rounded-2xl md:w-full",
          className,
        )}
        style={{ top: "unset" }}
        {...props}
