...
export const base: Registry["items"] = [
  {
    ...
    // Shipped as `css` rather than per-component `motion-reduce:` variants,
    // which only 6 of the 26 moving components actually carried. Spinner uses
    // SVG SMIL, so essential loading motion is unaffected.
    css: {
