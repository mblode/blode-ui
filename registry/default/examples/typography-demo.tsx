export const TypographyDemo = () => (
  <div>
    <h2 className="scroll-m-20 text-balance font-extrabold text-4xl tracking-tight">
    ...
    <p className="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <a className="font-medium text-primary underline underline-offset-4" href="#the-jokes">
        a brilliant plan
      </a>
