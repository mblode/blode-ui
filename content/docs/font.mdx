...
Download [glide-variable.woff2](https://ui.blode.co/glide-variable.woff2), [glide-variable-italic.woff2](https://ui.blode.co/glide-variable-italic.woff2) and [glide-mono.woff2](https://ui.blode.co/glide-mono.woff2) and place them in your project's `public/` directory.
