...
<div className="space-y-2">
  <div className="text-sm text-muted-foreground">Glide Mono</div>
...
<div>
  <div className="text-sm text-muted-foreground mb-2">Font weight: 500 (Medium)</div>
  <p className="font-sans font-medium text-xl">The quick brown fox jumps over the lazy dog.</p>
</div>

<div>
  <div className="text-sm text-muted-foreground mb-2">Font weight: 600 (Semibold)</div>
  <p className="font-sans font-semibold text-xl">The quick brown fox jumps over the lazy dog.</p>
</div>

<div>
  <div className="text-sm text-muted-foreground mb-2">Font weight: 700 (Bold)</div>
  <p className="font-sans font-bold text-xl">The quick brown fox jumps over the lazy dog.</p>
</div>

<div>
  <div className="text-sm text-muted-foreground mb-2">Font weight: 800 (Extrabold)</div>
