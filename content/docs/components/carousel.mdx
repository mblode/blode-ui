...
<ComponentPreview name="carousel-orientation" title="Carousel" description="A vertical carousel." />
...
See the [Embla Carousel docs](https://www.embla-carousel.com/docs/api/plugins) for more information on using plugins.
