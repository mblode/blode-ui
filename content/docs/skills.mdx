...
- hosted at [blode.co/ui](https://blode.co/ui)
...
The skill covers listing the `@blode` namespace in shadcn's registry directory: the flat-registry and schema requirements, how to check the published registry against them, and the submission path into `shadcn-ui/ui`.
