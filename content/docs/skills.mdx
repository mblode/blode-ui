...
It also understands that registries can ship more than components now, including design-system payloads via `registry:base` and first-class font payloads via `registry:font`, such as `@blode/font-inter`.
