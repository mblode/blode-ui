...
Blode UI is a third-party shadcn registry hosted at `blode.co/ui`. The setup flow is the same as shadcn/ui with one extra step: add the registry namespace.
